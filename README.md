...
# Introduction
This is a mini application implementing REST CRUD operations with Pagination using ASP.Net Web Api 2 with Entity Framework and Autofac.

# Getting Started
- This project uses MSSQL Server, run the setup.sql to create the database and table.
...
- [Asp Web Api 2 + NHibernate](https://github.com/melardev/.NetWebApiADO.NetCrud)
- [Asp Web Api 2 + Autofac](https://github.com/melardev/.NetWebApiAutofac)
